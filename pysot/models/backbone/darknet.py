...
class DarknetFeature(nn.Module):
    def __init__(self, cfgfile, weightfile):
        ...
        self.blocks = parse_cfg(cfgfile)  # cfg관련 부분을 저장
        self.net_info, self.module_list = create_modules(self.blocks)  # cfg파일 정보를 통해 network 만들기
